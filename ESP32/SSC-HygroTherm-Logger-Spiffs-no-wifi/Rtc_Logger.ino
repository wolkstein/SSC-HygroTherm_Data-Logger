...
//    currentDataFile += ".CSV";
    ...
    loggerString += String(Clock.getDate(), DEC);
    loggerString += ".";
    loggerString += String(Clock.getMonth(Century), DEC);
    loggerString += ".";
    loggerString += String(2000+Clock.getYear(), DEC);
    loggerString += " ";
    loggerString += String(Clock.getHour(h12, PM), DEC);
    loggerString += ":";
    loggerString += String(Clock.getMinute() , DEC);
    loggerString += ":";
    loggerString += String(Clock.getSecond(), DEC);
    loggerString += ",";
